...
const login = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-[7rem]">
      <h1 className="font-semibold text-2xl text-slate-700">Admin Dashboard</h1>
      <form>
        <input
        ...
        <button
          ...
          className="bg-green-400 px-4 mx-auto block rounded-md text-white py-1 font-semibold"
        >
          Login
        </button>
      </form>
